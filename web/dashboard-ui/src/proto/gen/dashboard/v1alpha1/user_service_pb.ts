...
/**
 * @generated from message dashboard.v1alpha1.GetUsersRequest
 */
export class GetUsersRequest extends Message<GetUsersRequest> {
  /**
   * @generated from field: optional bool with_raw = 1;
   */
  withRaw?: boolean;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dashboard.v1alpha1.GetUsersRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "with_raw", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
  ]);
