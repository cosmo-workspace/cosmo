...
export const PasswordDialog: React.VFC<{ onClose: () => void; user: User }> = ({
  onClose,
  user,
}) => {
  ...
  return (
    <Dialog open={true} fullWidth maxWidth={"xs"}>
      ...
      <DialogContent>
        <Stack spacing={3} sx={{ pt: 1 }}>
          ...
          <TextFieldLabel
            ...
            startAdornmentIcon={<VpnKey />}
            InputProps={{
              endAdornment: (
                <InputAdornment position="end">
                  <IconButton
                    onClick={() => {
                      onCopy(user.defaultPassword!);
                    }}
                  >
                    <ContentCopy />
                  </IconButton>
      ...
      <DialogActions>
        ...
        >
          Make sure to copy default password now. You won’t be able to see it
          again!
        </Alert>
      </DialogActions>
    </Dialog>
 ...
 * Context
 */
export const PasswordDialogContext = DialogContext<{ user: User }>((props) => (
