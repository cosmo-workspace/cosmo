...
export const PasswordChangeDialog: React.VFC<{ onClose: () => void }> = ({
  onClose,
}) => {
          ...
          <Stack>
            ...
            <PasswordTextField
              ...
              helperText={
                ...
                (isNewPasswordError && "Passwords do not match")
              }
            />
          </Stack>
        </DialogContent>
 ...
 * Context
 */
export const PasswordChangeDialogContext = DialogContext((props) => (
