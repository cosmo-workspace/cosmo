...
import {
  ...
  PasswordChangeDialogContext,
} from "../../../views/organisms/PasswordChangeDialog";
...
describe("PasswordChangeDialog", () => {
  ...
  describe("behavior", () => {
    it("ok", async () => {
      ...
      await user.type(
        baseElement.querySelector('[name="currentPassword"]')!,
        "oldPassword"
      );
      await user.type(
        baseElement.querySelector('[name="newPassword1"]')!,
        "newPassword"
      );
      await user.type(
        baseElement.querySelector('[name="newPassword2"]')!,
        "newPassword"
      );
      loginMock.updataPassword.mockResolvedValue({} as any);
      await user.click(screen.getByText("Change Password"));
      expect(loginMock.updataPassword.mock.calls).toMatchObject([
    ...
    it("ng required", async () => {
      ...
      expect(
        screen
          .getAllByText("Current password")[0]
          .parentElement!.getElementsByClassName("MuiFormHelperText-root")[0]
      ).toBeUndefined();
      expect(
        screen
          .getAllByText("New password")[0]
          .parentElement!.getElementsByClassName("MuiFormHelperText-root")[0]
      ).toBeUndefined();
      expect(
        screen
          .getAllByText("Confirm password")[0]
          .parentElement!.getElementsByClassName("MuiFormHelperText-root")[0]
      ).toBeUndefined();
      await act(async () => {
        await user.click(screen.getByText("Change Password"));
    ...
    it("ng Contains spaces", async () => {
      ...
      expect(
        screen
          .getAllByText("Current password")[0]
          .parentElement!.getElementsByClassName("MuiFormHelperText-root")[0]
      ).toHaveTextContent("Contains spaces");
      expect(
        screen
          .getAllByText("New password")[0]
          .parentElement!.getElementsByClassName("MuiFormHelperText-root")[0]
