...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/dashboard.v1alpha1.UserService/DeleteUser", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.UserService/DeleteUser",
		svc.DeleteUser,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.UserService/GetUser", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.UserService/GetUser",
		svc.GetUser,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.UserService/GetUsers", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.UserService/GetUsers",
		svc.GetUsers,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.UserService/CreateUser", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.UserService/CreateUser",
		svc.CreateUser,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.UserService/UpdateUserDisplayName", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.UserService/UpdateUserDisplayName",
		svc.UpdateUserDisplayName,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.UserService/UpdateUserPassword", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.UserService/UpdateUserPassword",
		svc.UpdateUserPassword,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.UserService/UpdateUserRole", connect_go.NewUnaryHandler(
