...
func NewWorkspaceServiceHandler(svc WorkspaceServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/dashboard.v1alpha1.WorkspaceService/CreateWorkspace", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.WorkspaceService/CreateWorkspace",
		svc.CreateWorkspace,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.WorkspaceService/DeleteWorkspace", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.WorkspaceService/DeleteWorkspace",
		svc.DeleteWorkspace,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.WorkspaceService/UpdateWorkspace", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.WorkspaceService/UpdateWorkspace",
		svc.UpdateWorkspace,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.WorkspaceService/GetWorkspace", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.WorkspaceService/GetWorkspace",
		svc.GetWorkspace,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.WorkspaceService/GetWorkspaces", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.WorkspaceService/GetWorkspaces",
		svc.GetWorkspaces,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.WorkspaceService/UpsertNetworkRule", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.WorkspaceService/UpsertNetworkRule",
		svc.UpsertNetworkRule,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.WorkspaceService/DeleteNetworkRule", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.WorkspaceService/DeleteNetworkRule",
