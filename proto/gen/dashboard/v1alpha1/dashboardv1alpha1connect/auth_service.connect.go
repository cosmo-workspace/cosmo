...
func NewAuthServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) AuthServiceClient {
	...
	return &authServiceClient{
		login: connect_go.NewClient[v1alpha1.LoginRequest, v1alpha1.LoginResponse](
			httpClient,
			baseURL+"/dashboard.v1alpha1.AuthService/Login",
			opts...,
		),
		logout: connect_go.NewClient[emptypb.Empty, emptypb.Empty](
			httpClient,
			baseURL+"/dashboard.v1alpha1.AuthService/Logout",
			opts...,
		),
		verify: connect_go.NewClient[emptypb.Empty, v1alpha1.VerifyResponse](
			httpClient,
			baseURL+"/dashboard.v1alpha1.AuthService/Verify",
			opts...,
		),
	}
}
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/dashboard.v1alpha1.AuthService/Login", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.AuthService/Login",
		svc.Login,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.AuthService/Logout", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.AuthService/Logout",
		svc.Logout,
		opts...,
	))
	mux.Handle("/dashboard.v1alpha1.AuthService/Verify", connect_go.NewUnaryHandler(
		"/dashboard.v1alpha1.AuthService/Verify",
		svc.Verify,
		opts...,
	))
